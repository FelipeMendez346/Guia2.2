...
class Biblioteca(Gtk.Application):
    ...
    def do_activate(self):
        ...
        self.titulo_entry.set_text("Titulo")
        ...
        self.genero = Gtk.ComboBoxText()
        self.genero.append("Ficcion", "Ficcion")
        self.genero.append("Ciencia", "Ciencia")
        self.genero.append("Historia", "Historia")
        self.genero.append("Infantil", "Infantil")
        box.append(self.genero)
    ...
    def on_registrar_clicked(self, button):
        ...
        genero = self.genero.get_active_text()
        ...
        if (genero==None):
            ...
            self.mostrar_dialogo("Exito", f"El libro '{titulo}' se ha registrado con exito.")
